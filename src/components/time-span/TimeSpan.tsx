    ...
    <div
      ...
      <Controller
        ...
        render={({ onChange, value }): JSX.Element => (
          <Select<InputOption>
            disabled={disabled}
            id={sanitizeId(`${namePrefix}-resource-state`)}
        ...
        render={(field): JSX.Element => (
          <div
            ...
            <Checkbox
              ...
              disabled={disabled}
              id={sanitizeId(`${namePrefix}-full-day`)}
      ...
      <div
        ...
        <TimeInput
          ...
          id={sanitizeId(`${namePrefix}-start-time`)}
          hoursLabel="tunnit"
        ...
        <TimeInput
          ref={register()}
          disabled={disabled || fullDay}
          id={sanitizeId(`${namePrefix}-end-time`)}
          hoursLabel="tunnit"
          minutesLabel="minuutit"
          label="Päättyen"
      ...
      {resourceState === ResourceState.OTHER && (
        <div className="time-span__descriptions">
          <Controller
            ...
            render={({ onChange, value }): JSX.Element => (
              <TextInput
                id={sanitizeId(`${namePrefix}-description-fi`)}
          ...
          <Controller
            ...
            render={({ onChange, value }): JSX.Element => (
              <TextInput
                id={sanitizeId(`${namePrefix}-description-sv`)}
          ...
          <Controller
            ...
            render={({ onChange, value }): JSX.Element => (
              <TextInput
                id={sanitizeId(`${namePrefix}-description-en`)}
